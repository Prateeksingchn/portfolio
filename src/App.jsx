...
function App() {
  ...
  return (
      <section className='dark:bg-[#101010] w-[100vw] mx-auto min-h-[100vh]'>
        ...
        <div className='p-4 '>
          ...
          {/* --------------------------------- GRID-3 message section starts here  -------------------------------------- */}
          ...
          <div className='ring-1 dark:ring-white/10 ring-primary/5 flex flex-col p-8 h-full justify-center items-center rounded-3xl overflow-hidden relative lg:col-span-2 lg:row-start-4 bg-[#1A1A1A] dark:bg-secondary shadow-xl dark:shadow-thick'>
            <div className='relative p-8 text-center w-full'>
                ...
                <form
                 className='mt-6 sm:flex w-full lg:max-w-sm mx-auto'>
          ...
          {/* --------------------------------- GRID-3 Testimonials section starts here  -------------------------------------- */}
          ...
          {/* --------------------------------- GRID-3 Testimonials section ends here  -------------------------------------- */}





          {/* --------------------------------- GRID-3 last section starts here  -------------------------------------- */}
