...
const AnimatedInfographic = () => {
  return (
    <motion.div
      className="ring-1 dark:ring-white/10 ring-primary/5 flex flex-col p-6 h-full justify-between items-start rounded-3xl overflow-hidden relative lg:col-span-2 lg:row-start-4 bg-[#04040475] dark:bg-secondary shadow-xl dark:shadow-thick"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.5 }}
    >
      <div className="w-full space-y-4">
        <h2 className="text-3xl font-bold text-white">GitHub Insights</h2>
        <div className='flex gap-6'>
          <div className='w-1/2 space-y-4'>
            <p className="text-gray-400">A snapshot of my development journey and impact</p>
            <div className="h-64 w-full mx-auto overflow-hidden rounded-2xl bg-black/20">
