...
const projectsData = [
  {
    ...
    image: './webui/web1.webp',
    technologies: ['Portfolio', 'Next.js', 'React', 'TypeScript', 'JavaScript', 'Shadcn UI', 'TailwindCSS', 'Framer motion', 'GSAP', 'Vercel'],
  ...
  },
  {
    ...
    image: './webui/web21.webp',
    technologies: ['React', 'TailwindCSS', 'JavaScript', 'Shadcn UI', 'Framer Motion', 'GSAP', 'API'],
    sourceCode: 'https://github.com/Prateeksingchn/gallery-app',
    liveDemo: 'https://pixelperfect-three.vercel.app/',
  ...
  },
  {
    ...
    image: './webui/web33.webp',
    technologies: ['React', 'JavaScript', 'Node.js', 'Express', 'MongoDB', 'TailwindCSS', 'Firebase', 'Framer Motion', 'API'],
    sourceCode: 'https://github.com/Prateeksingchn/Recipe-App',
    liveDemo: 'https://reciperanch.vercel.app/',
    filters: ['frontend', 'React', 'top'],
  },
  // {
  //   id: 4,
  ...
  // },
  {
    ...
    technologies: ['Node.js', 'Express.js', 'MongoDB', 'EJS', 'TailwindCSS', 'Firebase', 'Passport.js'],
  ...
  },
  {
    ...
    technologies: ['Node.js', 'Express.js', 'MongoDB', 'EJS', 'JavaScript', 'TailwindCSS', 'Firebase', 'Passport.js'],
  ...
  },
  {
    ...
    image: './public/webui/s2fnew.webp',
    technologies: ['React', 'JavaScript', 'TailwindCSS', 'Framer Motion', 'Sass'],
  ...
  },
  {
    ...
    technologies: ['React', 'JavaScript', 'Tailwind', 'Framer Motion', 'Sass'],
